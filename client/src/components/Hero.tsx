...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-12 pb-16 md:pt-24 md:pb-24 bg-background">
          ...
          <div className="space-y-6 relative z-10">
            ...
            >
              <motion.div
                ...
                animate={{
                  boxShadow: ["0 10px 15px -3px rgba(37, 99, 235, 0.25)", "0 20px 25px -5px rgba(37, 99, 235, 0.4)", "0 10px 15px -3px rgba(37, 99, 235, 0.25)"]
                }}
                transition={{
                  duration: 2,
                  repeat: Infinity,
              ...
              >
                <Button size="lg" className="h-16 px-10 text-lg bg-primary hover:bg-primary/90 text-white hover:-translate-y-0.5 transition-all rounded-full">
