    ...
    <section className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
          ...
          >
            <div className="w-16 h-16 mb-6 bg-yellow-50 rounded-2xl flex items-center justify-center text-yellow-600 border border-yellow-100">
              <Trophy className="w-8 h-8 fill-yellow-600" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-foreground">Guaranteed Lowest Rates</h3>
          ...
          <motion.div
            ...
            className="bg-white p-8 rounded-3xl shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
          >
            <div className="w-16 h-16 mb-6 bg-pink-50 rounded-2xl flex items-center justify-center text-pink-600 border border-pink-100">
              <Scissors className="w-8 h-8" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-foreground">Zero Lender Fees</h3>
            <p className="text-muted-foreground leading-relaxed mb-6 flex-grow">
          ...
          <motion.div
            ...
            className="bg-white p-8 rounded-3xl shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
          >
            <div className="w-16 h-16 mb-6 bg-red-50 rounded-2xl flex items-center justify-center text-red-600 border border-red-100">
              <Siren className="w-8 h-8 fill-red-600" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-foreground">24/7 Rate Monitoring</h3>
            <p className="text-muted-foreground leading-relaxed mb-6 flex-grow">
